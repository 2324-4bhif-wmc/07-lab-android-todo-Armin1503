...
* Nun habe ich das Frontend aus Aufgabe 1 überarbeitet
...
* Dieses Projekt enthält mehrere Entitäten, REST-Service-Client und eine Ausgabe der Daten auf dem UI
